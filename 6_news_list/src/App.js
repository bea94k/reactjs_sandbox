...
class App extends Component {
  ...
  render() {
    ...
    const newsList = this.state.postsFromState.map(post => {
      return (
        <Post title={post.title} author={post.author} desc={post.decs} img={post.img} />
      )
    })

    return (
      <div className="news-grid">
        < Post title={this.state.postsFromState[0].title} author={this.state.postsFromState[0].author} desc={this.state.postsFromState[0].desc} img={this.state.postsFromState[0].img} />

        < Post title={this.state.postsFromState[1].title} author={this.state.postsFromState[1].author} desc={this.state.postsFromState[1].desc} img={this.state.postsFromState[1].img} />

        < Post title={this.state.postsFromState[2].title} author={this.state.postsFromState[2].author} desc={this.state.postsFromState[2].desc} img={this.state.postsFromState[2].img} />

        < Post title={this.state.postsFromState[3].title} author={this.state.postsFromState[3].author} desc={this.state.postsFromState[3].desc} img={this.state.postsFromState[3].img} />

        < Post title={this.state.postsFromState[4].title} author={this.state.postsFromState[4].author} desc={this.state.postsFromState[4].desc} img={this.state.postsFromState[4].img} />

        < Post title={this.state.postsFromState[5].title} author={this.state.postsFromState[5].author} desc={this.state.postsFromState[5].desc} img={this.state.postsFromState[5].img} />
